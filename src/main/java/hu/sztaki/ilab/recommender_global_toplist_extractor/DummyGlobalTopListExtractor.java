...
public class DummyGlobalTopListExtractor {
	...
	public static void main(String[] args) throws Exception {
		...
		// sort helyett group_reduce-al kellene!!! az partíciónkként kiszűri a top_k-t majd azokra lehet tolni egy sort-ot...
		...
		env.execute("DummyGlobalTopListExtractor");
